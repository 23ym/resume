...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
	...
	main: {
		educations: [
			{ name: 'ТАНГ', isEnd: true	},
			{ name: 'ТНЕУ', isEnd: false },
			{ name: 'ТДМУ',	isEnd: true	},
			{ name: 'ТЕІПО', isEnd: false },
			{ name: 'ЗНУ', isEnd: true },
			{ name: 'ТНПУ', isEnd: false },
		],
		certificates: [
			{ name: 'Certificates One' , id: 1001 },
			{ name: 'Certificates Two' , id: 1002 },
			{ name: 'Certificates Three' , id: 1003	},
		],
	},
